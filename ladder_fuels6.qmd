...
tendency. While crown fires occur readily in short trees (< ~12 m height) of the northern boreal forest, the element in fuel complexes that enables crown fires in most tall conifer stands are ladder fuels. This term refers to any
...
the live canopy base. In Canada, early wildfire researcher J.G. Wright first noted nearly a century ago that 'crown fires are not likely to occur unless there is a large volume of fuel under the trees' [@wright1932]. Van Wagner [@vanwagner1977a], in describing his classic crown fire initiation model based on empirical
...
the flame height'. While the publication describing Van Wagner's model has become a classic (\> 1600 citations as of early 2026), methods for quantifying the effects of ladder fuels are still few and far between nearly 50 years later.
...
\[eq. 1\], where $h$ is heat of ignition, $z$ is live crown base height (LCBH), and $c$ is a dimensional constant derived empirically. Most modelling
...
fire model for use with measured or estimated fuel structure variables.
...
P=0.141); because of the small TH sample size (5 plots), however, it is an open question whether thinned plots actually had lower consumption. Using the overall mean SFC of 1.337 kg m\^{-2}, the two spread rate
